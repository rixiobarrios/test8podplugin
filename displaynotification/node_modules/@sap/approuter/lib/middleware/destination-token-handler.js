...
var self = module.exports = {
  ...
  replaceUserToken: function (options, cb){
    ...
    shouldRequestUserExchangeToken (session, options.destinationKey,function(err, askForToken){
      ...
      if (!askForToken) {
        var userExchangeToken = options.destinationKey && session.user.destinationKey ? session.user.destinationKey.destinationUserExchangeToken.token : session.user.destinationUserExchangeToken.token;
...
function shouldRequestUserExchangeToken(session,destinationKey, cb){
  var destinationTokensCache = destinationKey && session.user.destinationKey ? session.user.destinationKey.destinationUserExchangeToken : session.user.destinationUserExchangeToken;
