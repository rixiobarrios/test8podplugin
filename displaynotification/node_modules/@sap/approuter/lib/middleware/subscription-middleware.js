...
module.exports = function (req, res, next) {
  let saasRegistryCredentials = vcapUtils.getServiceCredentialsByLabel(SAAS_REGISTRY);
  let smsCredentials = vcapUtils.getServiceCredentialsByLabel(SUBSCRIPTION_MANAGER);
...
function getSubscriptionProcessType(req, saasRegistryCredentials,smsCredentials) {
  ...
  if (smsCredentials){
    ...
    if (req.url.startsWith(callBackPath.getDependenciesPrefix) && req.method === 'GET') {
  ...
  if (saasRegistryCredentials){
    ...
    if (req.url.startsWith(callBackPath.getDependenciesPath) && req.method === 'GET') {
