    ...
    destinationsData.forEach(function (destination) {
      if (destination.hasOwnProperty('sap.cloud.service')) {
        if (destination.hasOwnProperty('app_host_id')) {
          ...
          let sapCloudService = destination['sap.cloud.service'];
          if (html5RepoDestinations[sapCloudService]){
            html5RepoDestinations[sapCloudService]['appHostId'] =
                html5RepoDestinations[sapCloudService]['appHostId'] + ',' + destination.app_host_id;
          } else {
            html5RepoDestinations[sapCloudService] = {
