...
preferLocal | Boolean | x | Defines from what subaccount the destination is retrieved. If preferLocal is true destination is retrieved from provider subaccount, if false or undefined, from subscriber.
